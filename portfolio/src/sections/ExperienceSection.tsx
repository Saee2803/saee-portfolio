...
const experiences: ExperienceEntry[] = [
  {
    ...
    role: "Intern — NLP Smart Assistant Development",
    duration: "Dec 2025 – Feb 2026",
    location: "Navi Mumbai, Maharashtra",
    logo: "/Experience/mauli_infotech_opc_private_limited_logo.jpg",
    points: [
      "Built an intelligent NLP-based Smart Assistant using Python and modern AI/NLP techniques to process and understand natural language queries.",
      "Implemented text analysis, query handling, and automated response generation features to improve user interaction and task automation.",
      "Developed both Python backend with transformers and NLP libraries, and HTML/CSS/JavaScript frontend for real-time user interaction.",
      "Focused on real-world AI application development with features including natural language understanding, smart response generation, and intelligent command handling.",
    ],
    github: "https://github.com/Saee2803/NLP_Smart_Assistant.git",
    deployment: "https://nlp-backend-a9w9.onrender.com",
  },
